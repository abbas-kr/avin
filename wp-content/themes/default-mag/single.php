				...
				<div class="twp-single-next-post twp-secondary-font">
					<h3 class="twp-title">
						<a href="<?php echo esc_url( get_permalink( $next_post->ID ) ); ?>">
							<?php echo esc_html__('Next Post','default-mag'); ?><i class="fal fa-chevron-right"></i>
						</a>
					</h3>
					...
					<div class="twp-time twp-primary-text"><i class="fal fa-clock-o"></i><?php echo get_the_date('D M j , Y', $next_post->ID  ); ?></div>
